	...
	<div class="section-a">
		<nav class="crumbs-a">
			<ul>
				...
				<li class="active"><?php echo $this->lang->line('front_breadcrumb_data');?></li>
			</ul>
		</nav>
		<h1><?php echo $this->lang->line('front_map_title'); ?></h1>
		<div class="report-a">
			<div class="header">
				<div class="grid-a">
...
$realtime_period = $this->config->item ( 'realtimeresult_period_data' );
																								?>
                        <p class="info-a">
...
$average_quality_period = $this->config->item ( 'average_quality_period' );
						...
						<ul class="data-b">
                            <?php
								...
								href="<?php echo site_url('data/element/'.$realtime['indicator_id']);?>">
									...
									style="font-size: 1em;"><?php echo $realtime['sum_validated_value']; ?></strong>
						...
						<ul class="data-c">
                             <?php
																	...
																	foreach ( $average_qual as $av_qual ) :
																															?>
                                <li><span><?php echo $this->lang->line('etty_typ_ky_'.$av_qual['entity_type_id']) ?> </span>
					...
					<div class="column w25">
                             <?php
																													if (! isset ( $received_payement )) {
																														...
																														?>
                        <ul class="data-d">
							<li><a href="data/payment/1"> <img class="icon-a" width="30"
									height="34"
 						...
 						<?php echo anchor('data/export_pbf_manager',$this->lang->line('export_full_database'), 'class="button-b red icon icon-export"' ); ?>	 
		...
		<div class="grid-a">
			<div class="column w50">
				<div class="map-a" id="map_canvas" style="height: 500px;"></div>
			</div>
			<div class="column w50">
				<div class="quality-b">
                     <?php
    ...
    <h2><?php echo $this->lang->line('national_quantity'); ?></h2>
	<div id="district-quantity"
		class="table-a table-responsive table-quantities-a">
		<div id="data-slice">
			<table>
				<thead>
					<tr>
		...
		<p class="action">
            ...
            <?php echo anchor('data/export_front_quantite',$this->lang->line('export_full_data'), 'class="button-b red icon icon-export"' ); ?>
    ...
    <div class="header-a">
		<h2><?php echo $this->lang->line('national_quality');?></h2>
		<p class="info-a">
			<a class="tooltip-a" href="#" data-toggle="tooltip"
				data-placement="left"
	...
	<div id="district-quality" class="table-a box table-qualities-a">
		<table>
            <?php
					...
					foreach ( $entittypes as $type_key => $entitytype ) {
						...
						if ($entitytype != "Maternité isolée (MI)" and $entitytype != "Centre de Santé d’arrondissement (CSA)" and $entitytype != "Dispensaire Isolé (DI)") {
		...
		<p class="action">
		    <?php echo anchor('data/export_front_qualite/',$this->lang->line('export_full_data'), 'class="button-b small red icon icon-export"' ); ?>
			<?php
					
if (file_exists ( $filename_qual )) {
						
						echo anchor ( $download_link_qual, $this->lang->line ( 'download_full_data' ), 'class="button-b small red icon icon-export"' );
					}
					?>
        </p>
	...
	<div class="table-a box table-payment-a">
			...
			</span> <a class="button-b red icon icon-export"
				href="<?php echo site_url('data/export_front_payemet/1')?>"><?php echo $this->lang->line('export_full_data'); ?></a>
		</p>
	</div>
    <?php endif;?>
	<?php
...
<script>
	...
	var chartQuantity;
        var Script = {
			...
			if(chartQuantity!==undefined && chartQuantity!==null)
            ...
            parseData : function(serie) {
                ...
                var line1 = {
                    name : '<?php echo $this->lang->line('national_quantity'); ?>'
                };
                var line2 = {
            ...
            drawQuantityChart : function(copy,chartDiv) {
                ...
                chartQuantity = new Highcharts.Chart({
                    chart : {
                        renderTo : chartDiv,
                        type : 'line',
                        height : 360
