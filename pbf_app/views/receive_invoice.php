...
<div class="block">
	...
	echo form_open ( 'report/set_invoice_received' );
	$inv_send = array (
			'name' => 'invoice',
			'id' => 'invoice',
			'maxlength' => '11',
	...
	form_fieldset_close () . '</BR>' . 
	// Begin form footer...........
	form_submit ( 'submit', $this->lang->line ( 'app_form_receive' ), 'class="submit small"' ) . form_reset ( '', $this->lang->line ( 'app_form_cancel' ), 'onClick="history.go(-1);return true;" class="submit small"' );
