	...
	<div class="section-a">
		<nav class="crumbs-a">
			<ul>
				...
				<li><a
					href=<?php echo $this->config->item('base_url')."data/showzone/2/".$breadcrumb['lvl1_link'] ?>><?php echo $breadcrumb['lvl1_title'] ?></a></li>
				<li class="active"><?php echo $breadcrumb['lvl2_title'] ?></li>
			</ul>
		</nav>
		<h1><?php echo $breadcrumb['lvl2_title'].' : '.$this->lang->line('front_pbf_data'); ?></h1>
		<div class="report-a">
			<div class="header">
				<div class="grid-a">
						<?php if($pop!=''){?>
...
$average_quality_period = $this->config->item ( 'average_quality_period' );
                            ...
                            <?php
																												if (empty ( $real_time_result ['data'] )) {
																													...
																													foreach ( $real_time_result ['data'] as $result ) :
																														...
																														if ($realtime ['sum_validated_value'] != 0) {
																															?>
                                   <li><a
					...
					<div class="column w25">
				       ...
				       <?php
                        ...
                        <ul class="data-d">
							...
							<li>
								<?php
												// On n'affiche le montant que si elle n'est pas nul
												if ($received_payement ['realtime'] ['money_amount'] != 0) :
													?>
							 <a href="<?php echo site_url('data/payment/1');?>"> <img
									...
									<span><?php echo $received_payement['realtime']['money_usd_amount'];?> <?php echo $received_payement['realtime']['money_usd'];?></span></a>
								<?php endif;?>
							</li>
							
							<?php
												// On n'affiche le montant que s'il est different de 0
												if ($received_payement ['realtime'] ['per_capita_usd'] != 0) {
													?>
		...
		<div class="grid-a">
			<div class="column w50">
				<div class="map-a" id="map_canvas" style="height: 500px;">
                    <?php echo $map['js']; ?>
                </div>
			</div>
			<div class="column w50">
		...
		<ul class="links-a grid-a">
			<li class="column w100"><strong><?php echo $geos_title;?></strong>
                <?php
    ...
    <h2><?php echo $this->lang->line('district_quantity');?></h2>
	<div id="district-quantity" class="table-a table-quantities-a">
		...
		<p class="action">
           ...
           <?php echo anchor('data/export_showentities_quantite/'.$zone_id,$this->lang->line('export_full_data'), 'class="button-b red icon icon-export"' ); ?>
    ...
    <div class="header-a">
		<h2><?php echo $this->lang->line('district_quality');?></h2>
		<p class="info-a">
			<a class="tooltip-a" href="#" data-toggle="tooltip"
				data-placement="left"
	...
	<div id="district-quality" class="table-a box table-qualities-a">
		...
		<p class="action">
       <?php echo anchor('data/export_showentities_qualite/'.$zone_id,$this->lang->line('export_full_data'), 'class="button-b small red icon icon-export"' ); ?>
...
function InitHighChart()
{
	...
	var zone_id_current=<?php echo $zone_id; ?>;
	var siteUrl = "<?php echo site_url('data/json_chart_district')?>";
    ...
    $(function(){
        ...
        var Script = {
            ...
            parseData : function(serie) {
                ...
                var line1 = {
                    name : '<?php echo $this->lang->line('district_quantity'); ?>'
                };
                var line2 = {
                    name : '<?php echo $this->lang->line('regional_average_quantity'); ?>'
                };
                var line1Data = [];
                var line2Data = [];
