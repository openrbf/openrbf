...
require_once('pdf/color.php');
require_once('pdf/htmlparser.php');
...
var $paddingCell = 2; //(mm)
var $paddingCell2 = 4; //2*$paddingCell
...
function Table(&$html,$multipage=1){
...
private function getVAlign($v){
	$v = strtolower($v);
	return isset($this->PDF_VALIGN[$v])?$this->PDF_VALIGN[$v]:'T';
}
}//PDFTable
?>